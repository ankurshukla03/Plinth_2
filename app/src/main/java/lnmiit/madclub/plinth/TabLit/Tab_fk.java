...
import lnmiit.madclub.plinth.Literary.Fk.PS_fk;
import lnmiit.madclub.plinth.Literary.Fk.Register_fk;
import lnmiit.madclub.plinth.Literary.Fk.Synopsis_fk;
import lnmiit.madclub.plinth.Literary.Fk.rules_fk;
 ...
 */
public class Tab_fk  extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent i = new Intent(Tab_fk.this, ListEvents.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Synopsis_fk(), "Synopsis");
        adapter.addFragment(new PS_fk(), "Problem Statement");
        adapter.addFragment(new rules_fk(), "Rules");
        adapter.addFragment(new Register_fk(),"Register");
