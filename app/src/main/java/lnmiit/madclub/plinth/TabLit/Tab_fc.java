...
import lnmiit.madclub.plinth.Literary.FC.PS_fc;
import lnmiit.madclub.plinth.Literary.FC.Register_fc;
import lnmiit.madclub.plinth.Literary.FC.Synopsis_fc;
import lnmiit.madclub.plinth.Literary.FC.rules_fc;
 ...
 */
public class Tab_fc  extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent i = new Intent(Tab_fc.this, ListEvents.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Synopsis_fc(), "Synopsis");
        adapter.addFragment(new PS_fc(), "Problem Statement");
        adapter.addFragment(new rules_fc(), "Rules");
        adapter.addFragment(new Register_fc(),"Register");
