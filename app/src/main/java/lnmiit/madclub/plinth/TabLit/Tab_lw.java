...
import lnmiit.madclub.plinth.Literary.LyreWrite.PS_lw;
import lnmiit.madclub.plinth.Literary.LyreWrite.Register_lw;
import lnmiit.madclub.plinth.Literary.LyreWrite.Synopsis_lw;
import lnmiit.madclub.plinth.Literary.LyreWrite.rules_lw;
 ...
 */
public class Tab_lw  extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent i = new Intent(Tab_lw.this, ListEvents.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Synopsis_lw(), "Synopsis");
        adapter.addFragment(new PS_lw(), "Problem Statement");
        adapter.addFragment(new rules_lw(), "Rules");
        adapter.addFragment(new Register_lw(),"Register");
