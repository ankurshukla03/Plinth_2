package lnmiit.madclub.plinth.TabLit;
...
import lnmiit.madclub.plinth.Literary.TurnCoat.PS_turncoat;
import lnmiit.madclub.plinth.Literary.TurnCoat.Register_turncoat;
import lnmiit.madclub.plinth.Literary.TurnCoat.Synopsis_turncoat;
import lnmiit.madclub.plinth.Literary.TurnCoat.rules_turncoat;
 ...
 */
public class Tab_tc  extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent i = new Intent(Tab_tc.this, ListEvents.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Synopsis_turncoat(), "Synopsis");
        adapter.addFragment(new PS_turncoat(), "Problem Statement");
        adapter.addFragment(new rules_turncoat(), "Rules");
        adapter.addFragment(new Register_turncoat(),"Register");
