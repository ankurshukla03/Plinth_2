...
import lnmiit.madclub.plinth.Robotics.Lumos.Arena_lumos;
import lnmiit.madclub.plinth.Robotics.Lumos.PS_lumos;
import lnmiit.madclub.plinth.Robotics.Lumos.Register_lumos;
import lnmiit.madclub.plinth.Robotics.Lumos.Rules_lumos;
import lnmiit.madclub.plinth.Robotics.Lumos.Synopsis_lumos;

/**
 * Created by Ankur Shukla on 1/7/2016.
 */
public class TabActivity_Lumos extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent i = new Intent(TabActivity_Lumos.this, ListEvents.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Synopsis_lumos(), "Synopsis");
        adapter.addFragment(new PS_lumos(), "Problem Statement");
        adapter.addFragment(new Rules_lumos(), "Rules");
        adapter.addFragment(new Arena_lumos(),"Arena");
        adapter.addFragment(new Register_lumos(),"Register");
