...
import lnmiit.madclub.plinth.Astronomy.Into_TheUniv.PS_itu;
import lnmiit.madclub.plinth.Astronomy.Into_TheUniv.Register_itu;
import lnmiit.madclub.plinth.Astronomy.Into_TheUniv.Rules_itu;
import lnmiit.madclub.plinth.Astronomy.Into_TheUniv.Synopsis_itu;
...
import lnmiit.madclub.plinth.Coding.IUPC.Synopsis_iupc;
 ...
 */
public class Tab_itu  extends AppCompatActivity {
    ...
    private void setUpToolbar() {
        ...
        if (toolbar != null) {
            ...
            title.setText("Into The Universe");
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent i = new Intent(Tab_itu.this, ListEvents.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Synopsis_itu(), "Synopsis");
        adapter.addFragment(new PS_itu(), "Problem Statement");
        adapter.addFragment(new Rules_itu(), "Rules");
        adapter.addFragment(new Register_itu(),"Register");
