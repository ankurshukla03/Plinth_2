 ...
 */
public class Tab_AH extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent i = new Intent(Tab_AH.this, ListEvents.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Synopsis_au(), "Synopsis");
        adapter.addFragment(new PS_Au(), "Problem Statement");
        adapter.addFragment(new Rules_au(), "Rules");
        adapter.addFragment(new Register_Au(),"Register");
