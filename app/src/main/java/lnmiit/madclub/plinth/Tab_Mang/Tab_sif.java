...
import lnmiit.madclub.plinth.Management.SIF.ED_sif;
import lnmiit.madclub.plinth.Management.SIF.Register_sif;
import lnmiit.madclub.plinth.Management.SIF.Rules_sif;
import lnmiit.madclub.plinth.Management.SIF.Synopsis_sif;
 ...
 */
public class Tab_sif extends AppCompatActivity {
    ...
    private void setUpToolbar() {
        ...
        if (toolbar != null) {
            ...
            title.setText("StartUp Intern Fair");
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent i = new Intent(Tab_sif.this, ListEvents.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Synopsis_sif(), "Synopsis");
        adapter.addFragment(new ED_sif(), "Event Description");
        adapter.addFragment(new Rules_sif(), "Rules");
