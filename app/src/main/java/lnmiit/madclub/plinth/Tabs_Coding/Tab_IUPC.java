...
import lnmiit.madclub.plinth.Coding.IUPC.PS_iupc;
import lnmiit.madclub.plinth.Coding.IUPC.Register_iupc;
import lnmiit.madclub.plinth.Coding.IUPC.Rules_iupc;
 ...
 */
public class Tab_IUPC extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent i = new Intent(Tab_IUPC.this, ListEvents.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Synopsis_iupc(), "Synopsis");
        adapter.addFragment(new PS_iupc(), "Problem Statement");
        adapter.addFragment(new Rules_iupc(), "Rules");
        adapter.addFragment(new Register_iupc(),"Register");
