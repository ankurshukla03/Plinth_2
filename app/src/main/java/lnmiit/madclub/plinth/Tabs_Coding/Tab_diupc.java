 ...
 */
public class Tab_diupc extends AppCompatActivity {
    ...
    private void setUpToolbar() {
        ...
        if (toolbar != null) {
            ...
            title.setText("Distraction IUPC");
        }
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == android.R.id.home) {
            Intent i = new Intent(Tab_diupc.this, ListEvents.class);
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new Synopsis_diupc(), "Synopsis");
        adapter.addFragment(new PS_diupc(), "Problem Statement");
        adapter.addFragment(new Rules_diupc(), "Rules");
        adapter.addFragment(new Register_diupc(),"Register");
